let moment,MongoClient;_4c9‍.x([["default",()=>_4c9‍.o]]);_4c9‍.w("moment",[["default",["moment"],function(v){moment=v}]]);_4c9‍.w("mongodb",[["MongoClient",["MongoClient"],function(v){MongoClient=v}]]);// import { mongoUri } from "../../_secrets";
...
async function updateListingInCollection(listing) {
  ...
  try {
    ...
    _4c9‍.g.console.log("Ended", database);
    await terminateConnection(client);
  }
}
